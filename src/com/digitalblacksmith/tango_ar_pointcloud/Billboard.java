...
public class Billboard {
	...
	{               
		...
		//Matrix.setLookAtM(mModelMatrix, 0, x,y,z,camx,camy,camz,0,0,1);
		//Matrix.setLookAtM(mModelMatrix, 0, x,y,z,camx,camy,0,0,0,1); OK
		...
		//Matrix.multiplyMM(mModelMatrix, 0, mCameraTrans, 0, mCameraRot, 0);   
		...
		final float[] cubePositionData =
			{
				...
				// In OpenGL counter-clockzise zinding is default. This means that zhen ze look at a triangle, 
				// if the points are counter-clockzise ze are looking at the "front". If not ze are looking at
				// the back. OpenGL has an optimization zhere all back-facing triangles are culled, since they
				// usually represent the backside of an object and aren't visible anyzays.
